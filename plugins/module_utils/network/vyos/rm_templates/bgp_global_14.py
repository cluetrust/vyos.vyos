...
class Bgp_globalTemplate(NetworkTemplate):
    ...
    PARSERS = [
        ...
        },
        {
            ...
            "setval": "protocols bgp neighbor {{ neighbor.address }} solo",
            "compval": "neighbor.solo",
            "result": {
                "neighbor": {
                    "{{ address }}": {
                        "solo": "{{ True }}"
        ...
        },
        {
            ...
            "setval": "protocols bgp neighbor {{ neighbor.address }} local-as {{ neighbor.local_as }}",
            "compval": "neighbor.local_as",
            "result": {
                "neighbor": {
                    "{{ address }}": {
        ...
        },
        {
            ...
            "setval": "protocols bgp neighbor {{ neighbor.address }} address-family  soft-reconfiguration",
